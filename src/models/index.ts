export interface Valve {
  ...
  latitud: number; longitud: number; altitud?: number | undefined; precision?: number | undefined; sector: string; zona: string;
...
export interface FieldSurvey { id: string; valvula_id: string; latitud_campo: number; longitud_campo: number; precision_gps: number; altitud?: number | undefined; fecha: string; hora: string; observaciones: string; estado: 'guardado'|'exportado' }
...
export interface StorageInfo { data: number; photos: number; maps: number; total: number; available?: number | undefined }
export interface GpsPosition { latitude: number; longitude: number; accuracy: number; altitude?: number | undefined; timestamp: number }
